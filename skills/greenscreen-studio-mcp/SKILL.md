...
- Video auto-crop scans the requested frame range, then uses one stable anchor crop box for every frame; when no range is provided, it scans the full video.
